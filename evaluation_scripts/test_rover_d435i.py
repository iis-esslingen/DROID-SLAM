...
if __name__ == '__main__':
    ...
    tstamps = []
    for (t, image, depth, intrinsics) in tqdm(image_stream(args.data_path, use_depth=args.depth, stride=stride)):
    ...
    traj_est = droid.terminate(image_stream(args.data_path, use_depth=args.depth, stride=stride))
